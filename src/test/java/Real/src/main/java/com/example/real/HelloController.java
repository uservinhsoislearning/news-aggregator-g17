    ...
    private void filterData(String filterValue ,String column) {
        try {
            ...
            for (LineComponent lineComponent : data) {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("Line.fxml"));
                LineController lineController = new LineController(newStage, firstScene); // Truyền Stage vào LineController
